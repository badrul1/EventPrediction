...
\thesistitle{Song plays: Using machine learning to model the temporal patterns of music listeners} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
