...
\thesistitle{An evaluation of machine learning methods for modeling temporal point processes} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
