...
\thesistitle{An evaluation of machine learning methods for event prediction} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
