...
Sequential event prediction are a 

This problem can be modelled in different ways from a simple probabiity table for each period within a week, to a series of binary sequential time-series events representing whether a user listened to music in a period or not.
\LaTeX{} is easily able to professionally t
\emph{heavy} bold.
